"""Concept -> MusicGen prompt mapping.

Each concept id mirrors `lib/concepts.ts` on the frontend. Selecting a
different concept changes both the descriptive text sent to MusicGen and the
target BPM the generated track (and the hybrid mix) is built around.
"""
